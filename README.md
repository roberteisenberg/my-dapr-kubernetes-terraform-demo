...
expected_stdout_lines:
  - 'Deploying app "orderbackendapp" to Kubernetes'
  - 'Deploying app "pythonapp" to Kubernetes'
  - '== APP - orderbackendapp == Got a new order! Order ID: 12'
  - '== APP - orderbackendapp == Successfully persisted state for Order ID: 12'
...
sleep: 70
expected_stdout_lines:
  - "service/orderbackendapp created"
  - "deployment.apps/orderbackendapp created"
  - 'deployment "orderbackendapp" successfully rolled out'
tags:
  - normal-run
-->
...
output_match_mode: substring
match_order: none
name: Read orderbackendapp logs
tags:
  - normal-run
-->
...
working_dir: "./deploy/spec-files"
sleep: 10
expected_stdout_lines:
  - service "orderbackendapp" deleted
  - deployment.apps "orderbackendapp" deleted
